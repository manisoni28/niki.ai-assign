...
public class BDefines {
    ...
    public static String ServerUrl = "https://messaging-app-f625b.firebaseio.com/" + BRootPath;

    /** The url that is used for the file uploads.*/
    public static String FirebaseStoragePath = "gs://messaging-app-f625b.appspot.com";
